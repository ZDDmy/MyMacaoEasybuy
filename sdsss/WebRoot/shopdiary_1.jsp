...
<html>
  ...
  <body>
		  ...
		  <div class="am-g" style="">
		     <div class="am-u-lg-12 am-u-md-12 am-u-sm-12" style="padding:0;">
		        <button id="animation-start" type="button" class="am-btn btn_s1" >
		         ...
		         <div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="padding:10px;">
				 ...
				 <div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="padding:10px;">
                    <button type="button" class="btn_w3" style="border:0;" onClick="mem()">
                       ...
                       <span style="float:right;margin-top: -2px;"><span class="pr_t1">已有<span style="font-size:2rem;color:#aeaeae;">100</span>個店員&nbsp;&nbsp;&nbsp;</span><img src="images/right2.png" style="width: 20px;margin: 2px 0 0 0;"></span>
                    </button> 
				  </div>
				  <div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="padding:10px;">
					  ...
					  <div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="margin-top:5px;padding:0;">
					    <div class="am-panel-group" id="accordion" >
							  <div class="am-panel am-panel-default">
							    <div class="am-panel-hd" style="height: 50px;color: #f8af00;background-color: #ffffdb;border: 1px solid #dfdfd5;">
							      <p class="am-panel-title" data-am-collapse="{parent: '#accordion', target: '#do-not-say-1'}">
							         <span style="font-size:21px;padding-left: 10px;">創建日誌</span><span><img src="images/down5.png" style="float:right;margin-top: 5px;"></span>
							      </p>
							    </div>
							      ...
							      <div class="am-panel-bd" style="border:none;height:410px;padding: 5px 15px 0 15px;">
							        <div class="">
							            <div class="am-u-lg-12 am-u-md-12 am-u-sm-12 text_a" style="margin-top:5px;font-size:21px;padding:0;">
								           <input type="text" class="text1"  placeholder="我的日誌標題">
								        </div>
								  ...
								  <div class="am-panel am-panel-default">
								    <div class="am-panel-hd" style="height: 50px;color: #f8af00;background-color: #ffffdb;border: 1px solid #dfdfd5;">
								      <p class="am-panel-title" data-am-collapse="{parent: '#accordion', target: '#do-not-say-2'}">
								         <span style="font-size:21px;padding-left: 10px;">在辦事宜(<span>0</span>)項</span><span><img src="images/down5.png" style="float:right;margin-top: 5px;"></span>
								      </p>
								    </div>
								    <div id="do-not-say-2" class="am-panel-collapse am-collapse">
								      <div class="am-panel-bd" style="border:none;height:550px;background-color:#fff;overflow-y:scroll;">
								      </div>
								   </div>
							    </div>
						    </div>
								  ...
								  <div class="am-panel am-panel-default">
								    <div class="am-panel-hd" style="height: 50px;color: #f8af00;background-color: #ffffdb;border: 1px solid #dfdfd5;">
								      <p class="am-panel-title" data-am-collapse="{parent: '#accordion', target: '#do-not-say-3'}">
								         <span style="font-size:21px;padding-left: 10px;">待辦事宜(<span>0</span>)項</span><span><img src="images/down5.png" style="float:right;margin-top: 5px;"></span>
								      </p>
								    </div>
								  ...
								  <div class="am-panel am-panel-default">
								    <div class="am-panel-hd" style="height: 50px;color: #f8af00;background-color: #ffffdb;border: 1px solid #dfdfd5;">
								      <p class="am-panel-title" data-am-collapse="{parent: '#accordion', target: '#do-not-say-4'}">
								         <span style="font-size:21px;padding-left: 10px;">未辦事宜(<span>0</span>)項</span><span><img src="images/down5.png" style="float:right;margin-top: 5px;"></span>
								      </p>
								    </div>
	    ...
	    <div style="text-align:center;display:block;" id="sha">
	       <img src="images/noshop9.png" class="in_img"><br>
	       <p style="font-size:21px;">暫時還沒有數據哦<br>有事宜需要記下嗎？</p>
	       <button class="but_37" id="b1" data-am-collapse="{parent: '#accordion', target: '#do-not-say-1'}">我要記下日誌</button>
	    </div>
