    ...
    <link rel="stylesheet" type="text/css" href="css/style.css">
     ...
     <script type="text/javascript">
			...
			function   saves(){   
			       ...
			       window.location.href="suppliersearch.jsp";   
					  ...
					  <div class="am-panel ">
					    <div class="am-panel-hd" style="padding:0;">
					      <div class="am-u-lg-12 am-u-md-12 am-u-sm-12 sup_1" style=""id="">
			                 <span  class="btn_s" style="padding-left:5px;float:left;" data-am-collapse="{parent: '#accordion', target: '#do-not-say-1'}"><img  src="images/add_.png" class="d_img4" style="margin-top: -4px;">&nbsp;<span class="p_t2" style="font-size:1.9rem;">創建</span></span>
			                 <span class="s_t1" style="font-size:2rem;margin-left:-37px;">供應商</span>
			                 <span data-am-collapse="{parent: '#accordion', target: '#do-not-say-2'}" style="float:right;margin-top: -2px;"><img src="images/search_2.png" class="s_img_1" style="margin-right: 5px;width: 42px;"></span>
                           </div>
		                </div>
		                <!--創建供應商 -->
												   ...
												   <table class="am-table am-table-bordered tabad2">
													  <tr >
														<td style="border:none;width:50%;padding:0;" >
														    <select id="my-select" multiple data-am-selected>
							...
							<div class="am-u-lg-12 am-u-md-12 am-u-sm-12" style="padding:0;background-color:#00c7df;" id="">
								...
								<div class="am-u-lg-12 am-u-md-12 am-u-sm-12" style="padding:0;" id="">
									<div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="padding:5px;" id="">
										<table class="am-table am-table-bordered tabad">
											<tr>
												<td class="tab_td" style="border:none;width:120px;"><span>供應商名稱：</span>
												</td>
												<td style="padding:0;border:none;"><input type="text"
													class="text1" placeholder="填寫供應商名稱">
												</td>
											</tr>
										</table>
									</div>
									<div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="padding:5px;"
										...
										<table class="am-table am-table-bordered tabad2">
											<tr>
												<td style="border:none;width:100%;padding:0;"><select
													class="sup_2_" style="">
														<option value="a">&nbsp;&nbsp;請選擇商品狀態</option>
														<option value="b">&nbsp;&nbsp;Banana</option>
														<option value="o">&nbsp;&nbsp;Orange</option>
									...
									<div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="padding:5px;"
										...
										<table class="am-table am-table-bordered tabad">
											<tr>
												<td class="tab_td" style="border:none;width:80px;"><span>聯絡人：</span>
												</td>
												<td style="padding:0;border:none;"><input type="text"
													class="text1" placeholder="填寫聯絡人名稱"></td>
											</tr>
										</table>
									</div>
								</div>
								<div class="am-u-lg-12 am-u-md-12 am-u-sm-12"
									style="padding:10px;" id="">
									<span style="color:#fff;">聯絡信息：</span>
								</div>
								<div class="am-u-lg-12 am-u-md-12 am-u-sm-12" style="padding:0;"
									...
									<div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="padding:5px;"
										...
										<table class="am-table am-table-bordered tabad">
											<tr>
												<td class="tab_td" style="border:none;width:98px;"><span>聯絡電話：</span>
												</td>
												<td style="padding:0;border:none;"><input type="text"
													class="text1" placeholder="填寫供應商聯絡電話"></td>
											</tr>
										</table>
									</div>
									<div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="padding:5px;"
										...
										<table class="am-table am-table-bordered tabad">
											<tr>
												<td class="tab_td" style="border:none;width:104px;"><span>Whatsapp：</span>
												</td>
												<td style="padding:0;border:none;"><input type="text"
													class="text1" placeholder="填寫供應商Whatsapp號" id="txt"
													onchange="IsNum3()"></td>
											</tr>
										</table>
									</div>
									<div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="padding:5px;"
										...
										<table class="am-table am-table-bordered tabad">
											<tr>
												<td class="tab_td" style="border:none;width:86px;"><span>Wechat：</span>
												</td>
												<td style="padding:0;border:none;"><input type="text"
													class="text1" placeholder="填寫供應商Wechat號"></td>
											</tr>
										</table>
									</div>
									<div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="padding:5px;"
										...
										<table class="am-table am-table-bordered tabad">
											<tr>
												<td class="tab_td" style="border:none;width:64px;"><span>LINE：</span>
												</td>
												<td style="padding:0;border:none;"><input type="text"
													class="text1" placeholder="填寫供應商LINE號" id="txt1"
													onchange="IsNum3()"></td>
											</tr>
										</table>
									</div>
								...
								<div class="am-u-lg-12 am-u-md-12 am-u-sm-12" style="padding:0;"
									...
									<div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="padding:5px;"
										...
										<table class="am-table am-table-bordered"
											style="margin-bottom:0;border:none;width:100%;">
											<tr>
												<td style="border:none;width:50%;padding:0 5px 0 0;">
													<table class="am-table am-table-bordered tabad2">
														<tr>
															<td style="border:none;width:50%;padding:0;"><select
																multiple data-am-selected>
																	<option value="b">Banana</option>
																	<option value="o">Orange</option>
																	<option value="m">Mango</option>
															</select></td>
								...
								<div class="am-u-lg-12 am-u-md-12 am-u-sm-12"
									style="padding:0 0 20px 0;text-align:center;" id="">
									<button class="but_13" onclick="saves()">搜索</button>
								</div>
							</div>
						</div>
					    </div>
				  ...
				  <tr >
					<td style="padding:0 10px 0 10px;">	
						 ...
						 <div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="padding:10px 5px 0 5px;">
						    <table class="am-table am-table-bordered tabad" >
							  <tr >
							    <td style="width:100%;padding:0 0 0 5px;border:none;">
						           <table class="am-table am-table-bordered tabad2" style="">
									  <tr >
										<td style="border:none;width:50%;padding:0;">
						 ...
						 <div class="am-u-lg-3 am-u-md-6 am-u-sm-12" style="padding:10px 5px 0 5px;">
						   <div class="am-u-lg-6 am-u-md-6 am-u-sm-6" style="padding:0 5px 0 0;">
						    <table class="am-table am-table-bordered tabad">
							  <tr >
								<td style="padding:0;border:none;">   
									<input type="text" class="text1" placeholder="聯絡人" >
								</td>
							   </tr>
							 </table>
						    </div> 
							  <div class="am-u-lg-6 am-u-md-6 am-u-sm-6" style="padding:0 0 0 5px;">
								 <table class="am-table am-table-bordered tabad" >
								  <tr >
									<td style="padding:0;border:none;">   
										<input type="text" class="text1" placeholder="聯絡電話">
									</td>
								  </tr>
								</table>  
							  </div>
