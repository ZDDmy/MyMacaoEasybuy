  ...
  <body style="background-color:#fdfff1;">
          ...
          <div class="am-g" style="background-color:#fffdf6;">
             ...
             <div style="padding: 0 0 10px 0;text-align:center;display:block;" id="supe">
                  <span><img src="images/supnosearchad.png" class="in_img"></span><br>
                  <span style="font-size:19px;">沒有符合條件的資料哦！</span><br>
                  <br>
                  <br>
		          <span><button class="but_37" id="supd" style="margin-bottom:80px;background-color: #ff0a4f;">返回供應商列表</button></span>
             </div>
