...
public class UpLoadUserHeadImage extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		mySmartUpload.setMaxFileSize(40000 * 20000);
		mySmartUpload.setAllowedFilesList("gif,jpg,bmp,txt,doc,xls,htm,html,JPG");//"jpg,gif,png,jpeg,bmp"
		try {
			...
			response.sendRedirect("/sdsss/uploadimage.jsp?Picurl="
					+ FileName + "&step=2");
		} catch (Exception e) {
			e.printStackTrace();
		}
